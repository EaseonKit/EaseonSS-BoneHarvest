...
public class ConfigManager {
    ...
    private static final File CONFIG_FILE = new File(CONFIG_DIR, "easeon.ss.boneharvest.json");
    ...
    public void load() {
        ...
        try (FileReader reader = new FileReader(CONFIG_FILE)) {
            ...
            Easeon.LOGGER.info("Config loaded: enabled = {}, required OP level = {}", enabled, requiredOpLevel);
        } catch (IOException e) {
    ...
    public void save() {
        try {
            ...
            Easeon.LOGGER.info("Config saved: enabled = {}, required OP level = {}", enabled, requiredOpLevel);
        } catch (IOException e) {
